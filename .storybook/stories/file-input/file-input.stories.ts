...
import { ClrFileInputContainer, ClrFileInputModule, ClrFormLayout, commonStringsDefault } from '@clr/angular';
...
export default {
  ...
  component: ClrFileInputContainer,
  decorators: [
    moduleMetadata({
  ...
  argTypes: {
    ...
    // methods
    browse: { control: false },
    clearSelectedFiles: { control: false },
    addGrid: { control: false },
    controlClass: { control: false },
  },
  args: {
    // inputs
    buttonLabel: commonStringsDefault.browse,
  },
};
