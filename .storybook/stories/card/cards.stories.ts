  ...
  template: `
    <div [style.maxWidth.px]="maxWidth" class="card" [ngClass]="{ clickable }">
      ...
      <ul *ngIf="itemCount" class="list-group">
          <li
            *ngFor="let _ of createArray(itemCount); let i = index"
